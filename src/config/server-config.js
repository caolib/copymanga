...
// 默认API源
const DEFAULT_API_SOURCES = ['https://api.copy2000.online', 'https://copy20.com']
...
export async function getAppConfig() {
  ...
  if (
    result.bookApiSources.length > 0 &&
    (result.currentBookApiIndex >= result.bookApiSources.length || result.currentBookApiIndex < 0)
  ) {
