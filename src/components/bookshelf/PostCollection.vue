<template>
  <div class="post-collection">
    ...
    <div
      ...
      v-if="(!props.loading && !internalLoading) || postList.length > 0"
    >
    ...
    <div v-if="totalCount > pageSize" class="pagination-container">
      <a-pagination
        ...
        :show-total="(total, range) => `第 ${range[0]}-${range[1]} 条，共 ${total} 个写真`"
...
import { usePostCollectionStore } from '@/stores/post-collection.js'
