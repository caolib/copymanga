  ...
  <div class="post-ranking-tab">
    ...
    <a-tabs v-model:activeKey="activeTab" @change="handleTabChange">
      ...
      <a-tab-pane key="week" tab="周排行榜">
        <RankingList
          :data="weekRanking.list"
          :total="weekRanking.total"
          :loading="weekRanking.loading"
          :error="weekRanking.error"
          :current-page="weekPageConfig.current"
          :page-size="weekPageConfig.size"
      ...
      <a-tab-pane key="month" tab="月排行榜">
        <RankingList
          :data="monthRanking.list"
          :total="monthRanking.total"
          :loading="monthRanking.loading"
          :error="monthRanking.error"
          :current-page="monthPageConfig.current"
      ...
      <a-tab-pane key="total" tab="总排行榜">
        <RankingList
          :data="totalRanking.list"
          :total="totalRanking.total"
          :loading="totalRanking.loading"
          :error="totalRanking.error"
          :current-page="totalPageConfig.current"
...
import { usePostRankingStore } from '@/stores/post-ranking.js'
