  ...
  <div>
    ...
    <a-row :gutter="20" style="margin-bottom: 20px">
      <a-col :xs="24" :md="8">
        <a-card title="日排行榜" style="margin-bottom: 20px">
          <div
            v-for="(item, index) in homeData.rankDayComics?.list?.slice(0, 10) || []"
            :key="item.comic.path_word"
            class="rank-item"
            @click="goToMangaDetail(item.comic)"
          >
      ...
      <a-col :xs="24" :md="8">
        <a-card title="周排行榜" style="margin-bottom: 20px">
          <div
            v-for="(item, index) in homeData.rankWeekComics?.list?.slice(0, 10) || []"
            :key="item.comic.path_word"
            class="rank-item"
            @click="goToMangaDetail(item.comic)"
          >
      ...
      <a-col :xs="24" :md="8">
        <a-card title="月排行榜" style="margin-bottom: 20px">
          <div
            v-for="(item, index) in homeData.rankMonthComics?.list?.slice(0, 10) || []"
            :key="item.comic.path_word"
            class="rank-item"
            @click="goToMangaDetail(item.comic)"
          >
    ...
    <a-collapse v-model:activeKey="activeKeys">
      ...
      <a-collapse-panel key="banners" header="轮播图">
        <a-carousel autoplay>
          <div
            ...
            :key="banner.type + banner.out_uuid"
            class="banner-item"
      ...
      <a-collapse-panel key="topics" header="专题推荐">
        <a-row :gutter="16">
          <a-col
            v-for="topic in homeData.topics?.list?.slice(0, 6) || []"
            :key="topic.path_word"
            :xs="24"
            :sm="12"
            :md="8"
      ...
      <a-collapse-panel key="recommended" header="推荐漫画">
        <a-row :gutter="16">
          <a-col
            v-for="item in homeData.recComics?.list || []"
            :key="item.comic.path_word"
            :xs="12"
            :sm="8"
            :md="6"
      ...
      <a-collapse-panel key="hotComics" header="热门漫画">
        <a-row :gutter="16">
          <a-col
            v-for="item in homeData.hotComics || []"
            :key="item.comic.path_word"
            :xs="12"
            :sm="8"
            :md="6"
      ...
      <a-collapse-panel key="newComics" header="新作漫画">
        <a-row :gutter="16">
          <a-col
            v-for="item in homeData.newComics || []"
            :key="item.comic.path_word"
            :xs="12"
            :sm="8"
            :md="6"
      ...
      <a-collapse-panel key="finishComics" header="完结漫画">
        <a-row :gutter="16">
          <a-col
            v-for="comic in homeData.finishComics?.list || []"
            :key="comic.path_word"
            :xs="12"
            :sm="8"
            :md="6"
