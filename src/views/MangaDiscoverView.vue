            ...
            <div class="filter-group">
                ...
                <div class="filter-buttons">
                    ...
                    <a-button :type="currentFilter.ordering === '-datetime_updated' ? 'primary' : 'default'"
                        size="small" @click="changeOrdering('-datetime_updated')">
                        更新时间
                    </a-button>
                </div>
                <div class="filter-actions">
                    <a-button type="primary" @click="refreshData" :icon="h(ReloadOutlined)" :loading="loading"
                        size="small">
                        刷新
                    </a-button>
...
const refreshData = async () => {
    // 强制刷新标签和列表
    const tagsResult = await mangaDiscoverStore.fetchFilterTags(true)
