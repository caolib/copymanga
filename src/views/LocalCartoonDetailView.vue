                ...
                <a-row :gutter="32">
                    ...
                    <a-col :xs="24" :sm="16">
                        <a-typography-title :level="2"
                            :style="{ cursor: cartoon.path_word ? 'pointer' : 'default', color: cartoon.path_word ? '#1890ff' : 'inherit' }"
            ...
            <a-row justify="space-between" align="middle" style="margin-bottom: 12px;">
                <a-col>
                    <a-space>
                        ...
                        <!-- 刷新按钮 -->
                        <a-button @click="loadCartoonData" :loading="chaptersLoading" :icon="h(ReloadOutlined)"
                            size="small">
                            刷新
                        </a-button>
                        ...
                        <a-col :xs="12" :sm="8" :md="6" :lg="4" :xl="3" v-for="chapter in displayChapters"
                            :key="chapter.chapter_uuid"> <a-card size="small" :hoverable="true" class="chapter-card">
                                ...
                                <div class="chapter-info">
                                    <div class="file-size">
                                        大小: {{ formatFileSize(chapter.file_size) }}
                                    </div>
...
const displayChapters = computed(() => {
    ...
    if (isAscending.value) {
        return sorted.sort((a, b) => a.chapter_name.localeCompare(b.chapter_name, 'zh-CN', { numeric: true }))
    } else {
